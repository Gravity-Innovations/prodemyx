               ...
               <div className="row justify-content-center">
                  <div className="col-xl-5 col-lg-6">
                     <div className="banner__content-two">
                        <h3 style={{ fontSize:"36px", fontFamily:"monospace"}} className="title text-white" data-aos="fade-right" data-aos-delay="400">
                         
                          
                          ProdemyX isn’t a course.<br/> It’s  a 
                             <span className="position-relative" style={{ marginLeft: "10px", color:"#000" }}>
